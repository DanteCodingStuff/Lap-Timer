window.onload = function() {
    ...
    console.log(startBtn, startBtn, resetBtn);
    let minutesSet = 00;
    let secondsSet = 00;
    let tensSet = 00;
    let Interval;
...
stopBtn.onclick = function(){
    ...
    li.innerHTML = `laps: <span>${minutes.innerHTML}: ${seconds.innerHTML}: ${tens.innerHTML}</span>`;
...
// This is for the start timer function
